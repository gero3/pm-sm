...
var PM = function() {
    ...
    ASSERT(typeof process.env.HOME !== "undefined" || typeof process.env.APPDATA !== "undefined" , "'HOME' environment variable must be set!");

    this.context = {
        time: new Date().getTime(),
        homeBasePath: PATH.join(process.env.HOME || process.env.APPDATA, ".sourcemint")
    };
}
